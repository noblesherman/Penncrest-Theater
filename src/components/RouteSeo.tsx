...
const routes: RouteDefinition[] = [
  ...
  },
  {
    ...
    title: 'Parents Association | Support Penncrest Theater',
    description:
      'Support Penncrest Theater through the parents association, volunteer efforts, fundraising, and community involvement for student productions.',
    structuredData: [
      buildWebPageSchema(
        'Parents Association | Support Penncrest Theater',
        'Support Penncrest Theater through the parents association, volunteer efforts, fundraising, and community involvement for student productions.',
        '/parents-association'
      ),
      buildBreadcrumbSchema([
        { name: 'Home', path: '/' },
        { name: 'Parents Association', path: '/parents-association' }
      ])
    ]
  },
  {
  ...
  {
    path: '/family-ticket',
    title: 'Family Free Ticket | Penncrest Theater',
    description: 'Family free ticket claim page for eligible Penncrest Theater performances.',
    noindex: true
  },
  {
    path: '/admin/*',
