...
type LoginResponse =
  ...
  | { twoFactorSetupRequired: true; setupToken: string; manualEntryKey: string; otpAuthUrl: string };
    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          />
          <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-red-600 mb-2" style={{ fontFamily: 'system-ui, sans-serif' }}>
            Penncrest Theater
          </p>
          <h1 className="font-bold text-stone-900 leading-none" style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(2rem, 6vw, 2.8rem)' }}>
            Admin Portal
          </h1>
              ...
              {phase === '2fa' && (
                ...
                >
                  <div className="rounded-2xl border border-stone-100 bg-stone-50 px-4 py-4 text-center">
                    <p className="font-bold text-stone-900 mb-1 text-sm" style={{ fontFamily: 'Georgia, serif' }}>Authenticator Required</p>
                ...
                >
                  ...
                  {manualKey && (
                    <div className="rounded-xl border border-stone-100 bg-stone-50 p-3">
                      ...
                      <p className="font-mono text-xs text-stone-700 break-all leading-relaxed">{manualKey}</p>
                    </div>
                  )}
                  <div>
