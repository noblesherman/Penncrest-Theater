  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-2xl font-bold text-stone-900" style={{ fontFamily: 'var(--font-sans)' }}>Audit Log</h1>
        <button
          onClick={() => {
            void load();
          }}
          className="w-full rounded-lg border border-stone-300 px-3 py-1.5 text-sm text-stone-700 hover:bg-stone-50 sm:w-auto"
        >
          Refresh
        </button>
      </div>
